-- CreateEnum
CREATE TYPE "NewsCategory" AS ENUM ('TECHNOLOGY', 'BUSINESS', 'SPORTS', 'HEALTH', 'SCIENCE', 'ENTERTAINMENT');
...
-- CreateIndex
CREATE INDEX "SavedArticle_userId_publishedAt_idx" ON "SavedArticle"("userId", "publishedAt");
